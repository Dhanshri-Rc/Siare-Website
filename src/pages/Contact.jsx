...
{/* Map Section */}
<section className="w-full bg-white py-3 sm:py-4 overflow-hidden">
  <div className="w-full max-w-[1320px] mx-auto px-6 sm:px-8 md:px-12 lg:px-16 xl:px-20">
    ...
    <div
      className="
        ...
        hover:shadow-[0_14px_30px_rgba(0,27,87,0.08)]
      "
    >
      ...
      >
        ...
        <div className="flex items-center gap-2.5 mb-3">
          ...
          <div
            className="
              ...
              flex items-center justify-center hover:bg-[linear-gradient(180deg,#0c3067_0%,#0f468d_45%,#1251a0_100%)]
          ...
          <div>
            <h3 className="font-bold text-[#071d4f] text-[13px]">
              SIARE Head Office
            </h3>

            <p className="text-[#0d57b7] text-[10px] font-medium">
              Nagpur, Maharashtra
            </p>
          </div>
        </div>
        ...
        <button
          className="
            ...
            hover:-translate-y-1
            hover:shadow-[0_10px_20px_rgba(12,48,103,0.28)]
      ...
      >
        ...
        <div
          className="
            ...
            bg-[linear-gradient(180deg,rgba(255,255,255,0.04)_0%,rgba(7,29,79,0.08)_100%)]
